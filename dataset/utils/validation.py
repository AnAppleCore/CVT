...
class ValidationDataset(torch.utils.data.Dataset):
    def __init__(self, data: torch.Tensor, targets: np.ndarray, transform: transforms=None, target_transform: transforms=None) -> None:
        self.data = data
...
def get_train_val(train: datasets, test_transform: transforms,
    ...
    directory = 'dataset/val_permutations/'
